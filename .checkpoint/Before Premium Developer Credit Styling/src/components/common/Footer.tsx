...
export const Footer: React.FC<FooterProps> = ({ onRequestQuote }) => {
  ...
  return (
    <footer className="w-full">
      {/* Primary Dark Footer Section */}
      <div className="bg-gradient-to-b from-[#081220] to-[#040810] text-white border-t-2 border-[#2CB51D] pt-[60px] sm:pt-[68px] pb-[36px] sm:pb-[42px] relative overflow-hidden">
